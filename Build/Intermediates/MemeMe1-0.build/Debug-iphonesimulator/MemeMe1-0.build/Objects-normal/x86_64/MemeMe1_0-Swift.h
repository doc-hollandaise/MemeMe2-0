...
SWIFT_MODULE_NAMESPACE_PUSH("MemeMe1_0")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC9MemeMe1_011AppDelegate")
...
SWIFT_CLASS("_TtC9MemeMe1_014ViewController")
...
- (void)memeifyWithText:(UITextField * _Nonnull)text;
- (UIImage * _Nonnull)generateMemedImage SWIFT_WARN_UNUSED_RESULT;
- (void)saveWithMeme:(UIImage * _Nonnull)image;
- (void)share;
...
@interface ViewController (SWIFT_EXTENSION(MemeMe1_0)) <UIImagePickerControllerDelegate>
...
@interface ViewController (SWIFT_EXTENSION(MemeMe1_0)) <UITextFieldDelegate>
